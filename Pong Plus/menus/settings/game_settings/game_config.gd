...
var _magic_balls_enabled := false
...
func get_magic_balls_enabled() -> bool:
	return _magic_balls_enabled
...
func set_magic_balls_enabled(status: bool) -> void:
	_magic_balls_enabled = status
